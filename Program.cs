...
namespace BookSerene
{
    public class Program
    {
        static void Main(string[] args)
        {
            static void Main(string[] args)
            {
                ...
                while (running)
                {
                    ...
                    switch (userChoice)
                    {
                        ...
                        case 7:
                            Console.WriteLine("\nThank you for visiting Serene Spa & Salon!");
                            running = false;
                            break;
                        default:
            ...
            {
                BsssBService bookingService = new BsssBService();
                Console.WriteLine("\nAvailable Services:");
            ...
            static void BookAService()
            {
                ...
                {
                    Console.Write("Invalid format. Try again (yyyy-MM-dd hh:mm tt): ");
                }
            ...
            static void CancelBooking()
            {
                ...
                bool result = bookingService.CancelByName(name);
                Console.WriteLine(result ? "Booking canceled successfully." : "Booking not found.");
            }
            ...
            static void UpdateBooking()
            {
                ...
                while (!DateTime.TryParseExact(Console.ReadLine(), "yyyy-MM-dd hh:mm tt", CultureInfo.InvariantCulture, DateTimeStyles.None, out newDateTime))
                {
                    Console.Write("Invalid format. Try again (yyyy-MM-dd hh:mm tt): ");
                }

                bool updated = bookingService.UpdateBookingByName(name, newService, newDateTime);
                Console.WriteLine(updated ? "Booking updated successfully!" : "Booking not found.");
            }
        }
    }
}
